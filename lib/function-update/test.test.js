...
describe('update function', () =>
{
    ...
    dbType.sqliteDb = db;
    dbType.waitingList = waitingList;
    dbType.defaultOptions = new Options(mockContext, '/test');
    ...
    describe('Conditional Updates with Functions', () => {
        test('should update with conditional function', async () => {
            ...
            await expect(update(options)).rejects.toThrow('No valid updates to perform');
        });
