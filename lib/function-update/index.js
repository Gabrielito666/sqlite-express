...
new Promise(async(resolve, reject) =>
{
    ...
    if(!db) return reject(new Error("SqliteExpress - Update Error: The database is not defined"));
    if(!table) return reject(new Error("SqliteExpress - Update Error: The table is not defined"));
    if(!update) return reject(new Error("SqliteExpress - Update Error: The update is not defined"));
    if(!where) return reject(new Error("SqliteExpress - Update Error: The where is not defined"));
    if(!connector) return reject(new Error("SqliteExpress - Update Error: The connector is not defined"));
    ...
    const selectOptions = new Options([options]);
    selectOptions.set({
        db,
        table,
