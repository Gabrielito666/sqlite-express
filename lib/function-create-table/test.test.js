...
describe('createTable function', () => {
    ...
    describe('Basic Table Creation', () => {
        ...
        test('should create multiple tables', async () => {
            ...
            const optionsUsers = new Options(mockContext, '/test');
            optionsUsers.set({
                // @ts-ignore
                db: dbType,
                table: 'users',
            ...
            const optionsPosts = new Options(mockContext, '/test');
            optionsPosts.set({
                // @ts-ignore
                db: dbType,
                table: 'posts',
    ...
    describe('IF NOT EXISTS Behavior', () => {
        test('should not error when creating table that already exists', async () => {
            ...
            await expect(createTable(options2)).resolves.toBeUndefined();
