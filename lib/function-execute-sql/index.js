...
const {parametersEvalExecuteSQL} = require("../tool-parameters-eval");

/**
 * @typedef {import("../class-options/types").TypeParam} TypeParam
 * @typedef {import("../class-options/types").ExpectedParam} ExpectedParam
 * @typedef {import("./types").ExecuteSQLFunction<TypeParam, ExpectedParam>} ExecuteSQLFunction*/
/**@type {ExecuteSQLFunction}*/
const executeSQL = (options) =>
new Promise(( resolve, reject ) =>
{
    const {db, query, logQuery, expected, parameters, type} = parametersEvalExecuteSQL(options);
