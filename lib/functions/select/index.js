...
const selectSentence = ({table, select, where, connector, logQuery=true}) =>
{
...
const selectRows = (sqliteDb, {table, select, where, connector, logQuery=true}) =>
{
    const {finalQuery, parameters} = selectSentence({table, select, where, connector, logQuery});
...
const selectRow = (sqliteDb, {table, select, where, connector, logQuery=true}) =>
{
    const {finalQuery, parameters} = selectSentence({table, select, where, connector, logQuery});
    return new Promise((resolve, reject) =>
    {
...
const selectCeld = (sqliteDb, {table, select, where, connector, logQuery=true}) =>
{
    const {finalQuery, parameters} = selectSentence({table, select, where, connector, logQuery});
    return new Promise((resolve, reject) =>
    {
...
const selectColumn = (sqliteDb, {table, select, where, connector, logQuery=true}) =>
{
    const {finalQuery, parameters} = selectSentence({table, select, where, connector, logQuery});
    return new Promise((resolve, reject) =>
    {
